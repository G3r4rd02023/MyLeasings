...
using MyLeasings.Helpers;
using System;
using System.Linq;
using System.Threading.Tasks;

namespace MyLeasings.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("0801-1987-13256", "Gerardo", "Lanza", "glanza007@gmail.com", "33077964", "Calle El Paraiso", "Manager");
            var owner = await CheckUserAsync("0801-1996-12034", "José", "Martinez", "jmartinez@yopmail.com", "35045674", "Calle Luna Calle Sol", "Owner");
            var lessee = await CheckUserAsync("0810-1995-01802", "Angel", "Herrera", "aherrera@yopmail.com", "35062747", "Calle Luna Calle Sol", "Lessee");
        ...
        private async Task CheckPropertiesAsync()
        {
            ...
            {
                AddProperty("Calle 43 #23 32", "Ojojona", owner, propertyType, 800000M, 2, 72, 4);
                AddProperty("Calle 12 Sur #2 34", "Talanga", owner, propertyType, 950000M, 3, 81, 3);
                await _context.SaveChangesAsync();
            }
        }
